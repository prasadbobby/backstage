import{r as M,R as t}from"./index-CTjT7uj6.js";import{s as pe,M as de}from"./api-CKDuuaL7.js";import{l as fe}from"./lodash-CoGan1YB.js";import{a as ge}from"./useAsync-CXA3qup_.js";import{u as ve}from"./useDebounce-4fqASXX_.js";import{u as N,S as ye}from"./SearchContext-BQYqBmky.js";import{A as be}from"./Autocomplete-BL0OMwvD.js";import{T as he}from"./TextField-BFtNzNJg.js";import{C as we}from"./Chip-BiorTpGh.js";import{m as ke}from"./makeStyles-BZw-HJLd.js";import{a as oe,F as Se}from"./FormLabel-DRY6nBRH.js";import{F as qe}from"./FormControlLabel-CD-88aTi.js";import{C as Ae}from"./Checkbox-DEYQr7Pe.js";import{S as De}from"./Select-BaBxRLP6.js";import{S as $}from"./Grid--ddFL0KQ.js";import{P as w}from"./Paper-Ke9XSqW5.js";import{T as Ee}from"./TestApiProvider-CoiMLMhd.js";import"./ApiRef-BSBwTmJJ.js";import"./useMountedState-DkESzBh4.js";import"./useAnalytics-DTrkS1Gy.js";import"./ConfigApi-DBUUc3nU.js";import"./defaultTheme-DezMpTIo.js";import"./hoist-non-react-statics.cjs-yZcCaz5O.js";import"./Close-DGJKc6yA.js";import"./createSvgIcon-CEu-9q0m.js";import"./capitalize-CEQeKh-K.js";import"./withStyles-BgNv_OyU.js";import"./unstable_useId-B3Hiq1YI.js";import"./useControlled-CogIeAPD.js";import"./index-QA7F3UF1.js";import"./isMuiElement-Cb6QZSLO.js";import"./IconButton-DMfZr1mO.js";import"./ButtonBase-yy6Og9D-.js";import"./TransitionGroupContext-BtzQ-Cv7.js";import"./Popper-CXFT7TxZ.js";import"./Portal-DHXjgkAG.js";import"./ListSubheader-CY9DfITZ.js";import"./InputLabel-Dknt7r96.js";import"./formControlState-ByiNFc8I.js";import"./useFormControl-F4cJWIkJ.js";import"./Select-Byf0a4iw.js";import"./react-is.production.min-D0tnNtx9.js";import"./useTheme-NGQJGM2h.js";import"./Popover-Bztmh1sR.js";import"./Modal-6sUM5zfZ.js";import"./classCallCheck-BNzALLS0.js";import"./Grow-jBfYqf2m.js";import"./utils-jlWbup7k.js";import"./List-Bh5ydWqT.js";import"./ListContext-DydK1sOh.js";import"./Typography-9Z2Fqq1t.js";import"./SwitchBase-_-HFDkTf.js";import"./createStyles-Bp4GwXob.js";import"./createStyles-yD3y8ldD.js";import"./Box-Bp1TnhXQ.js";import"./typography-DyYqqlXd.js";import"./MenuItem-cBwJq5VU.js";import"./ListItem-Bxb0CNHD.js";import"./ApiProvider-CuNQiN7Z.js";import"./index-BRV0Se7Z.js";const s=[];for(let e=0;e<256;++e)s.push((e+256).toString(16).slice(1));function Fe(e,n=0){return(s[e[n+0]]+s[e[n+1]]+s[e[n+2]]+s[e[n+3]]+"-"+s[e[n+4]]+s[e[n+5]]+"-"+s[e[n+6]]+s[e[n+7]]+"-"+s[e[n+8]]+s[e[n+9]]+"-"+s[e[n+10]]+s[e[n+11]]+s[e[n+12]]+s[e[n+13]]+s[e[n+14]]+s[e[n+15]]).toLowerCase()}let j;const Te=new Uint8Array(16);function Pe(){if(!j){if(typeof crypto>"u"||!crypto.getRandomValues)throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");j=crypto.getRandomValues.bind(crypto)}return j(Te)}const Ce=typeof crypto<"u"&&crypto.randomUUID&&crypto.randomUUID.bind(crypto),B={randomUUID:Ce};function Ie(e,n,l){if(B.randomUUID&&!n&&!e)return B.randomUUID();e=e||{};const a=e.random||(e.rng||Pe)();return a[6]=a[6]&15|64,a[8]=a[8]&63|128,Fe(a)}const R=(e,n,l=[],a=250)=>{const r=M.useRef({}),o=e||(()=>Promise.resolve([])),[v,c]=ge(o,[n],{loading:!0});if(ve(()=>{r.current[n]===void 0&&(r.current[n]=c(n).then(m=>(r.current[n]=m,m)))},a,[c,n]),l.length)return{loading:!1,value:l};const d=r.current[n];return Array.isArray(d)?{loading:!1,value:d}:v},O=(e,n)=>{const{setFilters:l}=N();M.useEffect(()=>{n&&[n].flat().length>0&&l(a=>({...a,[e]:n}))},[])},ue=e=>{const{className:n,defaultValue:l,name:a,values:r,valuesDebounceMs:o,label:v,filterSelectedOptions:c,limitTags:d,multiple:m}=e,[k,y]=M.useState("");O(a,l);const S=typeof r=="function"?r:void 0,q=typeof r=="function"?void 0:r,{value:A,loading:u}=R(S,k,q,o),{filters:h,setFilters:p}=N(),D=h[a]||(m?[]:null),x=(f,g)=>{p(_=>{const{[a]:U,...W}=_;return g?{...W,[a]:g}:{...W}})},b=f=>t.createElement(he,{...f,name:"search",variant:"outlined",label:v,fullWidth:!0}),V=(f,g)=>f.map((_,U)=>t.createElement(we,{label:_,color:"primary",...g({index:U})}));return t.createElement(be,{filterSelectedOptions:c,limitTags:d,multiple:m,className:n,id:`${m?"multi-":""}select-filter-${a}--select`,options:A||[],loading:u,value:D,onChange:x,onInputChange:(f,g)=>y(g),renderInput:b,renderTags:V})};ue.__docgenInfo={description:"@public",methods:[],displayName:"AutocompleteFilter",props:{className:{required:!1,tsType:{name:"string"},description:""},name:{required:!0,tsType:{name:"string"},description:""},label:{required:!1,tsType:{name:"string"},description:""},values:{required:!1,tsType:{name:"union",raw:"string[] | ((partial: string) => Promise<string[]>)",elements:[{name:"Array",elements:[{name:"string"}],raw:"string[]"},{name:"unknown"}]},description:`Either an array of values directly, or an async function to return a list
