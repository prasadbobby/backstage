import{R as r}from"./index-CTjT7uj6.js";import{G as p}from"./Gauge-CQqHggIe.js";import{m as v}from"./makeStyles-DFHNDtjR.js";import{B as y}from"./Box-4hiNbBw1.js";import{I as b}from"./InfoCard-CbAbJxy7.js";const q=v({root:{height:"100%",width:250},rootSmall:{height:"100%",width:160}},{name:"BackstageGaugeCard"});function f(n){const t=q(n),{title:a,subheader:i,progress:u,inverse:s,deepLink:o,description:g,icon:l,variant:d,alignGauge:m="normal",size:e="normal",getColor:c}=n,k={inverse:s,description:g,getColor:c,value:u};return r.createElement(y,{className:e==="small"?t.rootSmall:t.root},r.createElement(b,{title:a,subheader:i,deepLink:o,variant:d,alignContent:m,icon:l,titleTypographyProps:{...e==="small"?{variant:"subtitle2"}:void 0},subheaderTypographyProps:{...e==="small"?{variant:"body2"}:void 0}},r.createElement(p,{...k,size:e})))}f.__docgenInfo={description:`{@link Gauge} with header, subheader and footer
